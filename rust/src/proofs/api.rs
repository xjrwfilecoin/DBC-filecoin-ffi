...
pub unsafe extern "C" fn fil_seal_commit_phase2(
    ...
    catch_panic_response(|| {
        ...
        let result = scp1o
            .and_then(|o| filecoin_proofs_api::seal::seal_commit_phase2(o, prover_id.inner, SectorId::from(sector_id)));
...
pub unsafe extern "C" fn fil_generate_winning_post(
    ...
    catch_panic_response(|| {
        ...
        if env::var("DISABLE_WEBAPI").is_err() {
            ...
            let result = to_private_replica_info_map(replicas_ptr, replicas_len).and_then(|rs| {
                filecoin_proofs_api::post::generate_winning_post(&randomness.inner, &rs, prover_id.inner)
            });
